...
import styles from './src/css/login'
import cStore from './redux/stores/configureStore'
        ...
        <Image source={appIcon} style={styles.appIcon}></Image>
          ...
          <View style={styles.rememberMeForgetContainer}>
           <CheckBox 
              ...
              size={15} />
            <TouchableOpacity onPress={btnClick}><Text style={styles.forgotPassword}>Forgot Password</Text></TouchableOpacity>  
          </View>
          <View>
